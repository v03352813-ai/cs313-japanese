/**
 * CS313 韩语研习社 · 经典热播韩剧【30部高光对白知识库】全自动批量生成器
 * 
 * 运行方式:
 *   node scripts/batch_kdrama_generator.cjs
 */
...
const KDRAMA_TS_PATH = path.join(PROJECT_ROOT, 'src', 'data', 'korean', 'kdrama.ts');

// 30 部顶流经典韩剧高清名场面与 TOPIK 教学知识库
const MASTER_DRAMA_SCENES = [
  // 1. 欢迎来到王之国 (King the Land) - 场景 1
  {
    ...
    dialogues: [
      ...
      },
      {
        ...
        durationSec: 3,
        highlightWords: [
          { word: '진짜', meaning: '真正 / 真的' },
          { word: '-고 싶다', meaning: '想做某事' }
        ],
        grammarNotes: '动词词干 + -고 싶다 (表示主观意愿：想要做某事)',
        clozeQuestion: {
          maskedKo: '진짜 너 (      ) 거 해.',
          maskedWord: '하고 싶은',
          options: ['하고 싶은', '보고 싶은', '듣고 싶은', '가고 싶은'],
          hint: '惯用句型：“想要做”（하고 싶다）。'
        }
      },
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '눈치를 보다', meaning: '看眼色 / 察言观色' },
          { word: '망설이다', meaning: '犹豫 / 踌躇' }
        ],
      ...
      },
      {
        ...
        durationSec: 3,
        highlightWords: [
          { word: '돌아서 가다', meaning: '掉头 / 绕道返回' },
          { word: '길', meaning: '道路 / 方向' }
        ],
        grammarNotes: '-(으)면 (条件连词：如果/要是...) + -는 거고 (就是这样做的)',
        clozeQuestion: {
          maskedKo: '길이 아니면 (      ) 가는 거고.',
          maskedWord: '돌아서',
          options: ['돌아서', '뛰어서', '멈춰서', '서둘러서'],
      ...
      },
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '낭떠러지', meaning: '悬崖 / 绝壁' },
          { word: '기어 올라가다', meaning: '爬上来' },
          { word: '다시', meaning: '再次 / 重新' }
        ],
        grammarNotes: '-(으)면 되다 (只要...就行了) + -(으)니까 (表原因：因为...)',
        clozeQuestion: {
          maskedKo: '(      )면 다시 기어 올라가면 되니까.',
          maskedWord: '낭떠러지',
          options: ['낭떠러지', '바다', '하늘', '어둠'],
          hint: '名词：“悬崖/绝壁”（낭떠러지）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '여러분', meaning: '各位 / 朋友们' },
          { word: '막 살다', meaning: '随心所欲地生活 / 随性生活' }
        ],
      ...
      },
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '생각해보면', meaning: '回想起来' },
          { word: '사리다', meaning: '谨小慎微 / 畏首畏尾' },
          { word: '-ㄴ 것 같다', meaning: '好像 / 觉得' }
        ],
        grammarNotes: '-면서 (伴随状态：一边...一边...) + -았/었던 것 같다 (对过去经验的回顾与推测)',
        clozeQuestion: {
          maskedKo: '생각해보면 나는 20대 때 너무 (      ) 살았던 거 같아.',
          maskedWord: '사리면서',
          options: ['사리면서', '웃으면서', '울면서', '달리면서'],
      ...
      },
      {
        ...
        durationSec: 6,
        highlightWords: [
          { word: '지나고 보다', meaning: '事后回看' },
          { word: '후회', meaning: '后悔' },
          { word: '-(으)ㄹ걸', meaning: '早知道就...' }
        ],
      ...
      },
      {
        ...
        durationSec: 8,
        highlightWords: [
          { word: '저촉되다', meaning: '触碰 / 抵触' },
          { word: '선', meaning: '底线 / 边界' }
        ],
        grammarNotes: '-지 않는 선에서 (在不...的范围/底线内)',
        clozeQuestion: {
          maskedKo: '법에 (      ) 않는 선에서 막 사세요.',
          maskedWord: '저촉되지',
          options: ['저촉되지', '어울리지', '지나치지', '벗어나지'],
      ...
      },
      {
        ...
        durationSec: 7,
        highlightWords: [
          { word: '아끼다', meaning: '吝惜 / 爱惜' },
          { word: '이것저것', meaning: '各种各样' },
          { word: '후회 없이', meaning: '毫不后悔地' }
        ],
        grammarNotes: '-지 말고 (否定连接：不要做A而做B) + -아/어 보다 (尝试做...)',
        clozeQuestion: {
          maskedKo: '마음도 (      ) 말고 이것저것 경험도 많이 해보고, 후회 없이.',
          maskedWord: '아끼지',
          options: ['아끼지', '버리지', '숨기지', '속이지'],
          hint: '动词：“吝啬/爱惜”（아끼다）。'
        }
      }
    ]
  ...
  // 3. 眼泪女王 (Queen of Tears)
  {
    ...
    dialogues: [
      ...
      },
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '살다', meaning: '活 / 生活' },
          { word: '오래오래', meaning: '长长久久 / 很久' }
        ],
        grammarNotes: '-아/어지다 (状态变化：变得...) + -고 싶다 (想要...)',
        clozeQuestion: {
          maskedKo: '당신이랑 같이, (      ).',
          maskedWord: '오래오래',
          options: ['오래오래', '빨리빨리', '조용히', '따로'],
          hint: '副词叠词：“长长久久”（오래오래）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 6,
        highlightWords: [
          { word: '눈부시다', meaning: '耀眼 / 灿烂' },
          { word: '적당하다', meaning: '恰当 / 合适' }
        ],
        grammarNotes: '形容词 + -아서/어서 (因果连词：因为...所以...)',
        clozeQuestion: {
          maskedKo: '너와 함께한 시간 모두 (      ).',
          maskedWord: '눈부셨다',
          options: ['눈부셨다', '어두웠다', '슬펐다', '무서웠다'],
      ...
      },
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '일어나다', meaning: '发生 / 起来' },
          { word: '잘못', meaning: '过错 / 失误' }
        ],
  ...
  // 5. 爱的迫降 (Crash Landing on You)
  {
    ...
    dialogues: [
      ...
      },
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '기도하다', meaning: '祈祷' },
          { word: '꼭', meaning: '一定 / 务必' }
        ],
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '수고하다', meaning: '辛苦 / 付出辛劳' },
          { word: '힘내다', meaning: '加油 / 振作' }
        ],
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '건드리다', meaning: '招惹 / 触碰' },
          { word: '가만두다', meaning: '放过 / 饶恕' }
        ],
        grammarNotes: '动词 + -지 않다 (长否定式：不...) + -(으)ㄹ 테니까 (警告语气)',
        clozeQuestion: {
          maskedKo: '내 호텔 직원 (      ) 마.',
          maskedWord: '건드리지',
          options: ['건드리지', '바라보지', '칭찬하지', '기다리지'],
          hint: '动词：“招惹触碰”（건드리다）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '추앙하다', meaning: '崇拜 / 推崇' },
          { word: '채워지다', meaning: '被填满 / 得到充实' }
        ],
  ...
  // 10. 来自星星的你 (My Love from the Star)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '얼마나', meaning: '多么 / 几许' },
          { word: '영원히', meaning: '永远 / 永久' }
        ],
        grammarNotes: '疑问副词 + -는지 (间接疑问句接续：究竟多么...)',
        clozeQuestion: {
          maskedKo: '내가 너를 얼마나 사랑하는지, 너는 (      ) 모를 거야.',
          maskedWord: '영원히',
          options: ['영원히', '천천히', '조용히', '당장'],
          hint: '时间副词：“永远”（영원히）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '버티다', meaning: '坚撑 / 挺住' },
          { word: '박수', meaning: '掌声 / 拍手' }
        ],
  ...
  // 12. 非常律师禹英禑 (Extraordinary Attorney Woo)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 6,
        highlightWords: [
          { word: '똑바로', meaning: '笔直地 / 正向地' },
          { word: '거꾸로', meaning: '倒着 / 逆向地' }
        ],
        grammarNotes: '动词 + -아/어도 (让步连词：即使...也...)',
        clozeQuestion: {
          maskedKo: '제 이름은 똑바로 읽어도 (      ) 읽어도 우영우입니다.',
          maskedWord: '거꾸로',
          options: ['거꾸로', '천천히', '크게', '다시'],
          hint: '副词：“倒着/反向”（거꾸로）。'
        }
      }
    ]
  ...
  // 13. 二十五，二十一 (Twenty-Five Twenty-One)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '응원', meaning: '应援 / 支持' },
          { word: '닿다', meaning: '到达 / 触及' }
        ],
    ...
    dialogues: [
      {
        ...
        highlightWords: [
          { word: '가치', meaning: '价值' },
          { word: '매기다', meaning: '评估 / 标价' },
          { word: '이루다', meaning: '实现 / 达成' }
        ],
  ...
  // 16. 太阳的后裔 (Descendants of the Sun)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '야', meaning: '喂（同辈呼唤）' },
          { word: '여기서', meaning: '在这儿' },
          { word: '뭐 하냐', meaning: '干嘛呢' }
        ],
        grammarNotes: '疑问代词 + -냐 (同龄同辈间的非敬语疑问句尾)',
        clozeQuestion: {
          maskedKo: '야, 김정환! 너 (      ) 뭐 하냐?',
          maskedWord: '여기서',
          options: ['여기서', '집에서', '학교에서', '가게에서'],
          hint: '指代当前站立的胡同位置。'
        }
      },
      {
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '멋지다 / 멋있다', meaning: '帅气、精彩' },
          { word: '-아/야', meaning: '呼格助词' }
        ],
        grammarNotes: '形容词基本阶感叹句尾 -다 (在此处表达反讽赞叹)',
        clozeQuestion: {
          maskedKo: '(      ), 연진아! 브라보! 박연진, 멋있다!',
          maskedWord: '멋지다',
          options: ['멋지다', '예쁘다', '슬프다', '무섭다'],
  ...
  // 20. 举重妖精金福珠 (Weightlifting Fairy Kim Bok-joo)
  {
  ...
  // 21. 大力女子都奉顺 (Strong Woman Do Bong-soon)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '짝사랑', meaning: '单恋 / 暗恋' },
          { word: '끝내다', meaning: '结束 / 告终' }
        ],
        grammarNotes: '副词 빨리 (快点) + -아/어 주达 (为我做某事)',
        clozeQuestion: {
          maskedKo: '(      ) 빨리 끝내. 그리고 나 좀 좋아해 줘.',
          maskedWord: '짝사랑',
          options: ['짝사랑', '첫사랑', '비밀', '숙제'],
          hint: '名词：“暗恋单恋”（짝사랑）。'
        }
      }
    ]
  ...
  // 23. 那年，我们的夏天 (Our Beloved Summer)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '계속', meaning: '继续 / 一直' },
          { word: '돌아오다', meaning: '回来 / 归来' }
        ],
    ...
    dialogues: [
      {
        ...
        durationSec: 6,
        highlightWords: [
          { word: '침묵하다', meaning: '沉默' },
          { word: '공범', meaning: '共犯' },
          { word: '결코', meaning: '决然 / 绝对' }
        ],
    ...
    dialogues: [
      {
        ...
        durationSec: 3,
        highlightWords: [
          { word: '방공호', meaning: '防空洞 / 避难所' },
          { word: '숨다', meaning: '隐藏 / 躲藏' }
        ],
        grammarNotes: '动词 + 过去形 았다/었다 (口语简短宣告：...来了) + 命令形',
        clozeQuestion: {
          maskedKo: '(      ) 왔다. 숨어.',
          maskedWord: '방공호',
          options: ['방공호', '선물', '친구', '손님'],
          hint: '比喻名词：“防空洞”（방공호）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '유일하다', meaning: '唯一 / 仅有' },
          { word: '구하다', meaning: '拯救 / 救助' }
        ],
        grammarNotes: '名词 + -(이)예요 (敬语判断：是...) + -아/어 주다 (为我做...)',
        clozeQuestion: {
          maskedKo: '당신이 내 인생의 (      ) 키예요.',
          maskedWord: '유일한',
          options: ['유일한', '특별한', '작은', '새로운'],
          hint: '冠形词：“唯一的”（유일하다）。'
        }
      }
    ]
  ...
  // 28. 虽然是精神病但没关系 (It\'s Okay to Not Be Okay)
  {
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '스스로', meaning: '自己 / 亲自' },
          { word: '토닥이다', meaning: '抚拍 / 安抚' }
        ],
        grammarNotes: '动词 + -고 (顺承连接) + -아/어 보다 (尝试做某事)',
        clozeQuestion: {
          maskedKo: '양팔을 교차해서 스스로를 (      ) 봐.',
          maskedWord: '토닥여',
          options: ['토닥여', '바라봐', '가르쳐', '안아'],
          hint: '动词：“轻轻抚拍”（토닥이다）。'
        }
      }
    ]
    ...
    dialogues: [
      {
        ...
        durationSec: 4,
        highlightWords: [
          { word: '다방면', meaning: '多方面 / 各领域' },
          { word: '결혼하다', meaning: '结婚' }
        ],
    ...
    dialogues: [
      {
        ...
        durationSec: 5,
        highlightWords: [
          { word: '소년범', meaning: '少年犯' },
          { word: '혐오하다', meaning: '厌恶 / 痛恨' },
          { word: '무섭다', meaning: '可怕 / 严厉' }
        ],
...
function generateTypeScriptFile() {
  const tsContent = `export interface DramaDialogueLine {
  id: number;
  speaker: string;
  role: string;
  avatarColor: string;
...
export const K_DRAMA_SCENES: KDramaScene[] = ${JSON.stringify(MASTER_DRAMA_SCENES, null, 2)};
...
`;
  ...
  fs.writeFileSync(KDRAMA_TS_PATH, tsContent, 'utf-8');
  console.log(`✅ 成功生成并注入 ${MASTER_DRAMA_SCENES.length} 部经典韩剧台词精讲库至: ${KDRAMA_TS_PATH}`);
}
