  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-4 sm:py-6 space-y-5 sm:space-y-6">
      ...
      <div
        ...
        className="group relative bg-gradient-to-r from-sky-500/10 via-indigo-500/5 to-teal-500/10 rounded-3xl p-5 sm:p-6 border border-sky-200/80 shadow-md shadow-sky-500/5 hover:shadow-xl hover:border-sky-300 transition-all duration-300 cursor-pointer overflow-hidden space-y-3"
      >
