...
export const KOREAN_LISTENING_DATA: ListeningLesson[] = [
  // ==========================================
  // --- 1. 日常点餐与生活支付 (初级) ---
  // ==========================================
  {
    id: 'lis-001',
    title: 'TOPIK I 经典：弘大咖啡厅点单与日常结账',
    level: 'TOPIK I (初级)',
    category: '场景对话',
    duration: '01:15',
    badge: '真题第1-4题型',
    isFreePreview: true,
    intro: '本篇为 TOPIK I 经典简短日常对白，考察初级核心词汇与敬语终结词尾。',
    scenario: '首尔弘大某咖啡厅内，店员与顾客之间的点单及支付对话。',
    sentences: [
      {
        id: 1,
        speaker: '점원 (店员)',
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        analysis: '广播核心内容是说明列车延误15分钟，选第2项。'
      }
    ]
  },

  // ==========================================
  // --- 3. 韩国大学留学与教授办公室答疑 (学术考级) ---
  // ==========================================
  {
    id: 'lis-003',
  ...
  },
  {
    ...
    sentences: [
      ...
      },
      {
        id: 3,
        speaker: '의사 (医生)',
        ko: '급성 위염 증상으로 보입니다. 3일치 약을 처방해 드릴 테니, 식후 30분에 복용하시고 자극적인 매운 음식은 피하세요.',
        zh: '看来是急性胃炎的症状。给您开3天的药，请在饭后30分钟服用，并尽量避免辛辣刺激的食物。',
        roman: 'Geupseong wiyeom jeungsang-euro boimnida. Sam-ilchi yageul...',
        keyVocab: [
          { word: '처방하다', meaning: '开处方' },
          { word: '복용하다', meaning: '服用（药物）' },
          { word: '자극적이다', meaning: '刺激性的' }
        ],
    ...
    questions: [
      {
        ...
        options: [
          '식사 전에 약을 먹을 것 (饭前服药)',
          '자극적이고 매운 음식을 피할 것 (避免辛辣刺激食物)',
          '매일 2시간씩 격렬한 운동을 할 것 (每天剧烈运动2小时)',
          '입원하여 정밀 수술을 받을 것 (住院接受精密手术)'
        ],
        correctIndex: 1,
        analysis: '医生明确建议 “자극적인 매운 음식은 피하세요 (避免辛辣刺激食物)”，故选第2项。'
      }
    ]
  },
  {
